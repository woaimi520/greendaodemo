...
public class Teacher {
    ...
    @JoinEntity(entity = TeacherJoinStudentBean.class,
            sourceProperty = "tId",
            targetProperty = "sId")
    private List<Student> studentBeanList;
     ...
     */
    @Generated(hash = 986310371)
    public List<Student> getStudentBeanList() {
        if (studentBeanList == null) {
            ...
            List<Student> studentBeanListNew = targetDao
                    ._queryTeacher_StudentBeanList(teaID);
            synchronized (this) {
                if (studentBeanList == null) {
